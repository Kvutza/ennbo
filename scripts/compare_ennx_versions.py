#!/usr/bin/env python3
"""Compare current ennx source to ennx==0.3.6 on TuRBO-ENN, TuRBO-ONE, and MORBO.
...
Example:
  python scripts/compare_ennx_versions.py
  python scripts/compare_ennx_versions.py --quick
  python scripts/compare_ennx_versions.py worker --optimizer turbo_enn --problem ackley_30d --version current
"""
...
def _main(args: argparse.Namespace) -> int:
    ...
    out_path = ROOT / "compare_ennx_versions_report.json"
    report = {
