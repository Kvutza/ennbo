...
mod tests {
    ...
    #[test]
    fn allocation_favors_the_better_trajectory() {
        let mut rng = StdRng::seed_from_u64(42);
    ...
    #[test]
    fn allocation_balances_cold_regions() {
        let mut rng = StdRng::seed_from_u64(42);
    ...
    #[test]
    fn allocation_accepts_objective_specific_utility() {
        let mut rng = StdRng::seed_from_u64(42);
        let tr = MultiTrustRegionState::new(
            2,
            MultiTrustRegionConfig::new(2, Default::default()),
    ...
    #[test]
    fn selection_is_global_and_diverse() {
        let mut rng = StdRng::seed_from_u64(42);
    ...
    #[test]
    fn independent_updates_follow_generating_region() {
        let mut rng = StdRng::seed_from_u64(42);
        let mut cfg = MultiTrustRegionConfig::new(2, Default::default());
    ...
    #[test]
    fn nearest_region_and_seed_distance_are_explicit() {
        let mut rng = StdRng::seed_from_u64(42);
        let mut cfg = MultiTrustRegionConfig::new(2, Default::default());
